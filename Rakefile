...
desc 'Generate documentation for the import extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ImportExtension'
...
desc 'Test the import extension.'
...
namespace :test do
  desc 'Functional test the import extension.'
  ...
  desc 'Unit test the import extension.'
